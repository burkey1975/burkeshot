...
http.createServer(async(req,res)=>{
 if(req.method==='POST'){res.writeHead(503,{'Content-Type':'application/json'});res.end(JSON.stringify({error:'This is the interface-only preview. Start START_BURKESHOT_V11.bat for camera analysis.'}));return}
