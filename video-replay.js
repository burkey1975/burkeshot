...
(function(){
 ...
 get('manualBallBtn').onclick=()=>{manualSelect=true;els.video.style.cursor='crosshair';els.resultNote.textContent='Click the centre of the golf ball in the video to save its zone, then select Re-analyse.'};
